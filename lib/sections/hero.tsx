    ...
    <section ref={heroRef} className="hero relative overflow-hidden">
      <div className="hero-banner w-full h-full bg-black absolute top-[0%] right-0">
        <Image
          ...
          fill
          priority
          src={heroBannerImage} alt="heroBannerImage" className="max-md:hidden mx-auto h-auto w-auto" />
        <Image
          // width={375}
          // height={812}
          fill
          src={heroBannerImageMobile} alt="heroBannerImageMobile" className="md:hidden mx-auto h-auto w-auto" />
        <div
          style={{
