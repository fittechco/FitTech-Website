      ...
      <div
        ...
        <div
          ...
          {data.AboutUs.map((section, i: number) => (
            <DisplayAbout key={section.title} image={section.image} index={i} title={section.title} description={section.description} />
          ))}
        </div>
      </div>
    </div>
    ...
    <div
      ...
      >
        ...
        <Image
          width={500}
          height={500}
          src={image} className="w-full h-full object-cover" alt="" />
      </div>
      <div
