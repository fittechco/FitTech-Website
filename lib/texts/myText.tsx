export function MyText({
    ...
    switch (type) {
        ...
        case "h2":
            return (
                <h2 className={className + " h2Text / font-montserrat text-3xl md:text-4xl lg:text-5xl "}>{children}</h2>
            )
        case "h3":
            return (
        ...
        case "h4":
            return (
                <h1 className={className + " h3Text / font-montserrat text-1xl md:text-2xl lg:text-4xl "}>{children}</h1>
            )
        case "span":
            return (
        ...
        case "p":
            return (
                <p className={className + " h3Text / font-montserrat text-lg md:text-2xl"}>{children}</p>
            )
        case "p2":
            return (
