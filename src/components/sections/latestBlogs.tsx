    ...
    return (
        ...
        className={`latestBlogs / flex flex-col gap-5 md:gap-12 / px-6 md:px-20 w-full `}>
            ...
            <div className="blogContainer / flex justify-center items-center /  ">
                ...
                className={`/ flex justify-start items-end / max-w-5xl max-h-96 overflow-hidden w-full h-full relative rounded-lg transition-all duration-1000 ease-in-out delay-200 ${visible? "opacity-100 translate-y-0" : "opacity-0 translate-y-1/4"} `}>
