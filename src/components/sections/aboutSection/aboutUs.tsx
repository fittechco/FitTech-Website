...
export default function AboutUs() {
  ...
  return (
    <div className="aboutUs / flex / w-full h-full / mt-40">
            ...
            >
              <div className={`flex flex-col gap-6 `}>
                ...
                <MyText type={"p"} className={"text-thirdColor3"}>
                  ...
                  Mohamad Hamoud and Ali Fouani, our company is driven by a
                  passion for helping gym businesses and supplement stores
                  succeed. At FitTech, we believe that technology can help
                  bridge the gap between the fitness world and the digital
                  world. We work tirelessly to provide our clients with
                  innovative solutions that make it easier to manage their
                  businesses, sell their products, and reach their goals.
                </MyText>
              </div>
            </div>
          </div>
