  ...
  return (
    ...
    >
      ...
      <div className="flex w-full gap-14 relative p-6 md:p-0">
        <div
          className={`absolute md:static top-0 left-0 bg-accentColor3 h-full md:h-auto w-full flex-1 -z-10 md:z-0 transition-all duration-1000 ease-in-out delay-200 md:max-h-[450px] ${
