...
export default function Services() {
    ...
    return (
        ...
        className="services / flex flex-col gap-3 md:gap-10  / m-4 md:m-20 ">
            <MyText type={"h2"} className={`text-thirdColor3 font-bold transition-all duration-500 ease-in-out  ${visible? "opacity-100 translate-x-0" : "opacity-0 -translate-x-1/4"} `}  >Our Services</MyText>
            <ServiceCards />
        </div>
    )
}
