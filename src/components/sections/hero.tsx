...
export default function Hero() {
  ...
  return (
    ...
    <section ref={heroRef} className="hero flex items-center / w-full h-full  bg-white  relative overflow-hidden z-10 px-6 md:px-20 min-h-[112vh]">
      ...
      <Polygon className={`-z-[1] absolute top-[40%] left-[0%] lg:-left-[4%]  transition-all duration-1000 ease-in-out hidden md:block delay-100 ${heroVisible? "scale-75 lg:scale-100":"scale-0"} `} />
      ...
      <Polygon className={`-z-[1] absolute top-[8%]  left-[60%] lg:left-[45%] transition-all duration-1000 ease-in-out delay-200  ${heroVisible? "scale-50 lg:scale-75 ":"scale-0"}`} />
