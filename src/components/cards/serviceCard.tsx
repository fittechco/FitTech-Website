...
export default function ServiceCard() {
    ...
    const visible = useIntersection(cardref, "200px")
    
    return(
        <div 
        ref={cardref}
        className={`seviceCard /   / rounded-2xl  max-w-[580px] max-h-[640px] overflow-hidden h-full relative transition-all duration-700 ease-in-out delay-200 ${visible? "opacity-100 translate-y-0" : "opacity-0 translate-y-1/2"} `}>
