...
export default function ServiceCard({
    ...
    return (
        <div
            ...
            <div className=" / flex flex-col  justify-between gap-20 / min-h-[400px] md:min-h-[640px] h-full  w-full p-3 md:p-6">
                <div className="cardIcon / py-3 px-5 md:py-6 md:px-8 bg-mainColor/40 backdrop-blur-sm w-fit rounded-2xl  ">
